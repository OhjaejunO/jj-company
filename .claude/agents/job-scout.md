...
## 평가 기준 (공고당)
- **1차 출처(원공고) 접속 확인 실패(404/403 등) 또는 애그리게이터만 확보된 공고는 적합도 부여 금지** — "확인 불가" 섹션으로 분리하고, 원공고 URL 확보를 "JJ가 할 일"로 남긴다.
- **마감일이 조회 시점 기준 경과한 공고는 적합도와 무관하게 판단 대상에서 제외한다** — "마감" 섹션으로 분리하고, 재공고 확인만 "JJ가 할 일" 후보로 남긴다.
