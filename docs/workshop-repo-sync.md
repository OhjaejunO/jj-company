...
> **상태**: 초기 동기 완료 (2026-08-30 · 710개 · 58.19 MB) · 🔴 **그 뒤 휴면** — 2026-08-30 이후
> 커밋 0, `workshop_repo_sync.py` 를 부르는 스케줄·스크립트가 없다(2026-09-20 실측).
> **백업 정본은 `workshop_backup.py` 의 zip(G: 사본)이다.** 재개 판단은 `docs\infra-backlog.md` 28번.
>
...
🔴 **2026-09-20 정정: 위 «병행» 은 실물이 아니다.** 레포 쪽은 2026-08-30 뒤로 한 번도 안
돌았다 — 지금 도는 것은 zip 하나이고, 레포의 «이력» 은 8/30 초기 동기 한 점뿐이다.
